...
else if(isset($_POST['update_product_btn']))
{
    ...
    meta_title='$meta_title', meta_description='$meta_description', meta_keywords='$meta_keywords', status='$status', trending='$trending',  
    qty='$qty',image='$update_filename' WHERE id='$product_id' ";
