            ...
            <div class="container product_data mt-3">
                <div class="row">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <h4>Ksh <span class="text-success fw-bold"></span><?= $product['selling_price']; ?></h4>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <button class="btn btn-primary px-4 addToCartBtn" value="<?= $product['id']; ?>"> <i class="fa fa-shoping-cart me-2"></i>Add to Cart</button>
                            </div>
                            <div class="col-md-6">
