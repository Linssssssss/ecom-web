...
{ 
    ...
    { 
       ...
       $query_run = mysqli_query($con, $query);
        ...
        $tracking_no = "zuriaccess".rand(1111,9999).substr($phone,2);
        $insert_query = "INSERT INTO orders (tracking_no, user_id, name, email, phone, address, total_price ) VALUES ('$tracking_no', '$userId', '$name', '$email', '$phone', '$address','$totalPrice') ";
